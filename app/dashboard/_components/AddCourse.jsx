...
import VideoRecommendation from './VideoRecommendation'; // Import the VideoRecommendation component
import LanguageForm from './LanguageForm'; // Import the LanguageForm component

function AddCourse() {
  const { user } = useUser();
  const [submittedLanguage, setSubmittedLanguage] = useState('kannada');

  // Callback function to update the language based on form input
  const handleLanguageSubmit = (language) => {
    setSubmittedLanguage(language.toLowerCase());
  };
  ...
  return (
    <div className="p-6 space-y-10 ">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 rounded-lg shadow-lg p-6">
        <div className="flex flex-col md:w-1/2 space-y-4">
          ...
          <p className="text-md text-gray-600">
            Know your Rights with the Help of Agri Shield
          </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        ...
        >
          ...
          <p className="text-white mb-4">
            A government-backed crop insurance scheme providing financial stability to farmers against natural calamities.
          </p>
          <Link href="https://pmfby.gov.in/home" className="text-blue-200 hover:underline">
            Visit Site
          </Link>
        </motion.div>
        ...
        >
          ...
          <p className="text-white mb-4">
            Provides crop insurance schemes to protect farmers against yield risks due to natural calamities and other factors.
          </p>
          <Link href="http://www.aicofindia.com/" className="text-purple-200 hover:underline">
            Visit site
          </Link>
        </motion.div>
        ...
        >
          ...
          <p className="text-white mb-4">
            Crop insurance offered by Bajaj Allianz covering a variety of risks like droughts, floods, and pests for farmers.
          </p>
          <Link href="https://www.bajajallianz.com" className="text-green-200 hover:underline">
            Visit site
          </Link>
        </motion.div>
      </div>
      ...
      {/* Language Form and Video Recommendations Section */}
      <div className="mt-10">
        <LanguageForm onSubmitLanguage={handleLanguageSubmit} />
